...
def load_file(filename, format_mesy=False, intended_lc=None, timing_chan=3, data_chan=2, n_gamma_co=0.0, consider_timing_pulses=True):
    data = None
    if format_mesy:
