...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 1), // double()(double, double, double, double, double, double, double, double)
...
/* 10 */ _CFFI_OP(_CFFI_OP_FUNCTION, 22), // void()(int, double *, double *, double, double, double, double, double, double, double)
/* 11 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
/* 12 */ _CFFI_OP(_CFFI_OP_POINTER, 1), // double *
...
static double _cffi_d_pulse_func(double x0, double x1, double x2, double x3, double x4, double x5, double x6, double x7)
{
  return pulse_func(x0, x1, x2, x3, x4, x5, x6, x7);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_pulse_func(PyObject *self, PyObject *args)
{
  double x0;
  double x1;
  double x2;
  ...
  if (!PyArg_UnpackTuple(args, "pulse_func", 8, 8, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7))
    return NULL;
  ...
  _cffi_restore_errno();
  { result = pulse_func(x0, x1, x2, x3, x4, x5, x6, x7); }
  _cffi_save_errno();
...
#else
#  define _cffi_f_pulse_func _cffi_d_pulse_func
#endif

static void _cffi_d_v_pulse_func(int x0, double * x1, double * x2, double x3, double x4, double x5, double x6, double x7, double x8, double x9)
{
  v_pulse_func(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_v_pulse_func(PyObject *self, PyObject *args)
{
  int x0;
  double * x1;
  double * x2;
  ...
  if (!PyArg_UnpackTuple(args, "v_pulse_func", 10, 10, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9))
    return NULL;
...
#else
#  define _cffi_f_v_pulse_func _cffi_d_v_pulse_func
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "pulse_func", (void *)_cffi_f_pulse_func, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_pulse_func },
  { "v_pulse_func", (void *)_cffi_f_v_pulse_func, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 10), (void *)_cffi_d_v_pulse_func },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__pulse_func(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__pulse_func(void) { return NULL; }
#  else
     init_pulse_func(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__pulse_func(void)
{
  return _cffi_init("_pulse_func", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_pulse_func(void)
{
  _cffi_init("_pulse_func", 0x2601, &_cffi_type_context);
}
#endif
